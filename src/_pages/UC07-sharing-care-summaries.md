...
2. There are challenges around data protection that mean records need to be redacted if they mention individuals who aren’t the person in question).  Local Authorities don’t have the capacity to rearrange or anonymise these, so they redact large portions instead (e.g. one adult accessed her records and received 900 pages, 95% of which was black ink). LAs tend to be quite risk averse about this, since historically they have not secured explicit consent from individuals for their data to be shared. If a person was known to the child, their name does not need to be redacted, but it is often less effort to redact. What does need redacting is any personal information that the child should not know about, but this can also cause issues with areas like family medical history.
