...
As a result, for each case a lot of information is captured across a range of forms, documents and case notes.

Social workers need to locate information across multiple records to:

* Produce outputs for children and adults
* Analyse patterns of behaviour and risk over time
* Arrive at decisions
...
* The user experience for social workers when using their case management systems improves, increasing their capacity to assess risk and saving time.
