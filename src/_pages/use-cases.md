...
In 2025, through extensive research and engagement with the sector, we identified a series of use cases where standards could support solutions to some of the most important information-sharing and data challenges facing the sector. We have since refined them to reflect new learning, evolving policy and practice, and incorporate adult social care.  

We undertook a prioritisation process to identify where standards could deliver the greatest impact and where common solutions could support multiple challenges. This has guided our standards development roadmap.

Each use case below sets out the challenge, how improved interoperability could help address it, and the benefits this could deliver for people, practitioners and organisations across social care. 
