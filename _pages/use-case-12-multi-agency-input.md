---
layout: default
permalink: /use_case_multi_agency_input
...
<ol type="A" style="font-weight: bold;">
  <li>
    ...
    <ol style="font-weight: normal;" type="i">
      <li>As a practitioner working in a multiagency team, I need all key partners to be able to view relevant aspects of a child’s record and input into the record of a child I am providing care for, so that the record provides a full picture of the child and their needs. </li>
      <li>As a practitioner working in a multiagency team, I need to a record of who has contributed to assessments and other key forms/documents so that I can have a better understanding of why certain decisions have been made and where to go for more information. </li>
      <li>As a practitioner working in a multiagency team but not employed by CS, I need access to CMS to view and edit children’s case files where I am the allocated professional (FFC). </li>
    </ol>
  </li>
  ...
  <li>
    ...
    <ol style="font-weight: normal;" type="i">
      <li>As a care provider/ care worker I can contribute observations or concerns (e.g., missed visits, safeguarding flags; poc) directly into a shared record, so that other professionals working with the person can have an up-to-date understanding of care and any risks. </li>
      <li>As a mental health practitioner, I can record updates linked to a person’s wellbeing, so that social care can respond proactively. </li>
      <li>As a reablement manager, I need to add information about a new care package to a shared record so that care workers can carry out care and social workers can view the details of the care package. </li>
    </ol>
  </li>
...
- Child’s goals and preferences
- Multi-agency assessments
- Healthcare data
- Education data

In the Children’s Social Care context, the multiagency team could include practitioners from a range of services, including:
...
- SEND
- Parental conflict
- School attendance and support teams
...
For Adult’s Social Care, professionals contributing to a shared record could include:
...
- VCS staff
- The person in receipt of care and their carer (see [use case 1](/use_case_access_and_contribute_to_shared_record))

### Benefits

With ability to input:

- Improved decision making by the multiagency team due to better collaboration.
- Time savings for social workers due to a reduction in having to obtain information from multiagency partners and reduced need to double key information.
...
If you spot an issue with this use case, please <a href="https://github.com/SocialCareData/standard/issues/new?template=content_issue.yml&title=Issue+regarding+Multi-agency+Input+Use+Case" target="_blank" rel="noopener noreferrer">create a new issue on GitHub</a>.

## Future use cases

If you would like to suggest a future use case, please <a href="https://github.com/SocialCareData/standard/issues/new?template=content_issue.yml&title=Suggesting+a+Multi-agency+Input+Use+Case" target="_blank" rel="noopener noreferrer">create a new issue on GitHub</a>.
