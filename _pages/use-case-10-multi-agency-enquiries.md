---
layout: default
permalink: /use_case_multi_agency_enquiries
...
If you spot an issue with this use case, please <a href="https://github.com/SocialCareData/standard/issues/new?template=content_issue.yml&title=Issue+regarding+Multi-agency+Enquiries+Use+Case" target="_blank" rel="noopener noreferrer">create a new issue on GitHub</a>.

## Future use cases

If you would like to suggest a future use case, please <a href="https://github.com/SocialCareData/standard/issues/new?template=content_issue.yml&title=Suggesting+a+Multi-agency+Enquiries+Use+Case" target="_blank" rel="noopener noreferrer">create a new issue on GitHub</a>.
